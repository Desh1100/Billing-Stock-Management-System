...
ALTER TABLE `item_list` ADD COLUMN `category_id` int(30) NOT NULL;

ALTER TABLE `item_list` ADD CONSTRAINT `fk_item_category`
    FOREIGN KEY (`category_id`) REFERENCES `category_list` (`id`);



    CREATE TABLE `fix_customer` (
...
ALTER TABLE `purchase_order_list` ADD CONSTRAINT `fk_item_category`
    FOREIGN KEY (`category_id`) REFERENCES `category_list` (`id`);*/
