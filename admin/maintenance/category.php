        ...
        <div class="container-fluid">
			<table class="table table-hovered table-striped">
				...
				<tbody>
					<?php 
					$i = 1;
                    $qry = $conn->query("SELECT * FROM `category_list` ORDER BY `category_name` ASC");
...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Category Details","maintenance/manage_category.php?id="+$(this).attr('data-id'),"mid-large")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-box'></i> Category Details","maintenance/view_category.php?id="+$(this).attr('data-id'),"")
		})
