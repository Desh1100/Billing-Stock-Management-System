<?php 
$qry = $conn->query("SELECT b.*, s.name as supplier, p.po_code, i.name as item_name, i.description, c.category_name 
                     FROM back_order_list b 
                     INNER JOIN supplier_list s ON b.supplier_id = s.id 
                     INNER JOIN purchase_order_list p ON b.po_id = p.id  
                     INNER JOIN bo_items bi ON b.id = bi.bo_id
                     INNER JOIN item_list i ON bi.item_id = i.id
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-1 px-2 text-center"><?php echo $category_name ?></td>
