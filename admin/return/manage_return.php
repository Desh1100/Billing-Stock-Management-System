...
<script>
    ...
    $(function(){
        ...
        $('#category_id').val(category); // Update the category input with the selected category
    });
            ...
            var list_item = new Promise(resolve=>{
                Object.keys(items[supplier_id]).map(function(k){
                    ...
                    var opt = $('<option>')
                        ...
                        opt.text(row.name)
                        opt.data('category', row.category_id); // Add category_id data attribute to the option
                    $('#item_id').append(opt)
                })
                resolve()
            })
    ...
    var category_name = items[supplier][item].category_name || 'N/A'; // Add this line to get the category name
    ...
    tr.find('.category').text(category_name); // Display category name in the table
