...
<div class="card card-outline card-primary">
    ...
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">Purchase Order Code</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">Unit Cost(Rs.)</th>
                ...
                <tbody>
                    <?php
                    $total = 0;
                    $qry = $conn->query("SELECT p.*, i.name, i.description, i.category_id, c.category_name FROM `po_items` p INNER JOIN item_list i ON p.item_id = i.id INNER JOIN category_list c ON i.category_id = c.id WHERE p.po_id = '{$id}'");
                ...
                <tfoot>
                    ...
                    <tr>
                        <th class="text-right py-1 px-2" colspan="5">Tax <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
