            ...
            <div class="container-fluid">
                ...
                <fieldset>
                    ...
                    <div class="row justify-content-center align-items-end">
                        ...
                        $item_arr = array();
                        $cost_arr = array();
                        $item = $conn->query("SELECT i.*, c.category_name FROM `item_list` i 
                                              INNER JOIN category_list c ON i.category_id = c.id 
                                              WHERE status = 1 ORDER BY i.name ASC");
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select id="category_id" class="custom-select">
                                    ...
                                    <?php
                                    $categories = $conn->query("SELECT * FROM `category_list` ORDER BY category_name ASC");
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <tbody>
                        ...
                        $total = 0;
                        if (isset($id)):
                            $qry = $conn->query("SELECT p.*, i.name, i.description, i.category_id, c.category_name 
                                             FROM `po_items` p 
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="6">Discount <input style="width:40px !important"
                        ...
                        <tr>
                            <th class="text-right py-1 px-2" colspan="6">Tax <input style="width:40px !important"
                            ...
                            <th class="text-right py-1 px-2 tax">
                                <?php echo isset($tax) ? number_format($tax) : 0 ?>
                            </th>
                        </tr>
                        <tr>
...
<script>
    ...
    $(function () {
        ...
        if (!!items[supplier_id]) {
            ...
            // Auto-select the category of the first item for the selected supplier
            var firstItemId = Object.keys(items[supplier_id])[0];
            var categoryId = items[supplier_id][firstItemId].category_id;
    ...
    function rem(_this) {
        ...
        $('#add_to_list').click(function () {
            ...
            var category_name = items[supplier][item].category_name || 'N/A';
    ...
    function calc() {
        ...
        $('.grand-total').text(parseFloat(grand_total).toLocaleString('en-US', { style: 'decimal', maximumFractionDigit: 2 }));
